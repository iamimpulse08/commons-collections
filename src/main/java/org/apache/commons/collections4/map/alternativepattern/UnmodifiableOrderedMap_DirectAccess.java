 ...
 * @since 3.0
 */
public final class UnmodifiableOrderedMap_DirectAccess<K, V> extends AbstractOrderedMapDecorator_DirectAccess<K, V> implements
    ...
    public static <K, V> OrderedMap<K, V> unmodifiableOrderedMap(final OrderedMap<? extends K, ? extends V> map) {
        ...
        return new UnmodifiableOrderedMap_DirectAccess<>(map);
    }
     ...
     */
    @SuppressWarnings("unchecked") // safe to upcast
    private UnmodifiableOrderedMap_DirectAccess(final OrderedMap<? extends K, ? extends V> map) {
