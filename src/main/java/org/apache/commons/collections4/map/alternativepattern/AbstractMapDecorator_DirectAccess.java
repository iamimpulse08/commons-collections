 ...
 * @since 3.0
 */
public abstract class AbstractMapDecorator_DirectAccess<K, V> extends AbstractIterableMap<K, V> {
     ...
     * @since 3.1
     */
    protected AbstractMapDecorator_DirectAccess() {
    }
     ...
     */
    protected AbstractMapDecorator_DirectAccess(final Map<K, V> map) {
