...
public class UnmodifiableOrderedMapDecoratorLayer4<K,V> extends UnmodifiableOrderedMapDecoratorLayer3<K, V> implements Unmodifiable, Serializable, OrderedMap<K, V> {
    ...
    public static <K, V> OrderedMap<K, V> unmodifiableOrderedMapNoDecorator(final OrderedMap<K, V> map) {
        ...
        return new UnmodifiableOrderedMapDecoratorLayer4<>(map);
    }
    ...
    public UnmodifiableOrderedMapDecoratorLayer4(final OrderedMap<K, V> map) { // TODO : Test LinkedHashMap implementation.
        super(map);
    }
