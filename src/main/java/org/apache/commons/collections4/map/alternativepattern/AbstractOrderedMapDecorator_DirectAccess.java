 ...
 * @since 3.0
 */
public abstract class AbstractOrderedMapDecorator_DirectAccess<K, V> extends AbstractMapDecorator_DirectAccess<K, V>
     ...
     * @since 3.1
     */
    protected AbstractOrderedMapDecorator_DirectAccess() {
    }
     ...
     */
    public AbstractOrderedMapDecorator_DirectAccess(final OrderedMap<K, V> map) {
        super(map);
    }
