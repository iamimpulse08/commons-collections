 ...
 * @since 3.0
 */
public final class UnmodifiableOrderedMap_DirectAccess_NoSuperClass<K, V> extends AbstractMapDecorator_DirectAccess<K, V> implements
    ...
    public static <K, V> OrderedMap<K, V> unmodifiableOrderedMap(final OrderedMap<? extends K, ? extends V> map) {
        ...
        return new UnmodifiableOrderedMap_DirectAccess_NoSuperClass<>(map);
    }
     ...
     */
    @SuppressWarnings("unchecked") // safe to upcast
    private UnmodifiableOrderedMap_DirectAccess_NoSuperClass(final OrderedMap<? extends K, ? extends V> map) {
