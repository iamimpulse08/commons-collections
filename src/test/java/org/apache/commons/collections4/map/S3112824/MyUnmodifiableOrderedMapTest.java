 ...
 */
package org.apache.commons.collections4.map.S3112824;
 ...
 */
public class MyUnmodifiableOrderedMapTest<K, V> extends AbstractOrderedMapTest<K, V> {
    ...
    public OrderedMap<K, V> makeFullMap() {
        ...
        addSampleMappings(m);
        return UnmodifiableOrderedMapNoDecorator.unmodifiableOrderedMapNoDecorator(m);
    }

    @Override
    public OrderedMap<K, V> makeObject() {
        return UnmodifiableOrderedMapNoDecorator.unmodifiableOrderedMapNoDecorator(ListOrderedMap.listOrderedMap(new HashMap<>()));
    }

    @Test
    void testDecorateFactory() {
        final OrderedMap<K, V> map = makeFullMap();
        assertSame(map, UnmodifiableOrderedMapNoDecorator.unmodifiableOrderedMapNoDecorator(map));

        assertThrows(NullPointerException.class, () -> UnmodifiableOrderedMapNoDecorator.unmodifiableOrderedMapNoDecorator(null));
    }
